...
DATA_FILE = SCRIPT_DIR.parent / 'data' / 'expenses.json'
...
def delete_expense(expense_id):
    ...
    for i, expense in enumerate(expenses):
        if expense['id'] == expense_id:
            ...
            save_expenses(expenses)
            print()             
            print(f'------ Expense ID {expense_id} deleted succesfully ------')
            print()    
            return
    ...
    for expense in expenses:
        if expense['id'] == expense_id:
            ...
            if amount is not None:
                ...
                save_expenses(expenses)
                print()
                print(f'------ Expense ID {expense_id} updated succesfully ------')
                print() 
...
def list_expenses():
    expenses=load_expenses()
    print()
    print('------ Ultimate Expense Tracker Software ------')
    print()
...
def export_expenses(output_path):
    expenses = load_expenses()

    if not expenses:
        print()
        print('!! [Error]: No expenses to export.')
        print()
    ...
    try:
        ...
        print()
        print(f'------ Expenses exported successfully to {output_path} ------')
        print()
    except Exception as e:
        print()
        print(f'!! [Error]: Error while exporting expenses: {e}')
        print()
